...
export default {
    ...
    data() {
        return {
            experiences: [
                ...
                {
                    logo: null,
                    title: "Webmaster & Senior Frontend Developer",
                ...
                {
                    logo: null,
                    title: "Microsoft Answer Desk Online Technician",
                ...
                {
                    logo: null,
                    title: "Graphics Designer & OIC - Link Department",
    ...
    methods: {
        isLast(index) {
            return this.experiences.length - 1 === index;
        },
    },
};
</script>
